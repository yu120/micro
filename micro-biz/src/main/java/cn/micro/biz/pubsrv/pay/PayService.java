...
public class PayService implements InitializingBean {
    ...
    public Map<String, String> pay(OrdersEntity order, String code, OrdersGoodsEntity orderGoods) throws Exception {
    ...
    public OrdersEntity tradeQuery(PayChannelEnum payBy, String outTradeNo) {
        if (PayChannelEnum.ALIPAY.getStatus() == payBy.getStatus()) {
