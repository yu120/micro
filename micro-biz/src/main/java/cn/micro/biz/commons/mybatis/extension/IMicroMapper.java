...
public interface IMicroMapper<T> extends BaseMapper<T> {
     ...
     * @return {@link T }
     */
    default int delete(SFunction<T, Serializable> eqColumn, Serializable eqValue) {
     ...
     * @return {@link T }
     */
    default int update(T entity, SFunction<T, Serializable> eqColumn, Serializable eqValue) {
     ...
     * @return {@link List<T> }
     */
    default List<T> selectListEqAndIn(SFunction<T, Serializable> eqColumn, Serializable eqValue,
     ...
     * @return {@link List<T> }
     */
    default List<T> selectListEqAndIn(SFunction<T, Serializable> eqColumn1, Serializable eqValue1,
                                      SFunction<T, Serializable> eqColumn2, Serializable eqValue2,
                                      SFunction<T, Serializable> inColumn, Object... inValues) {
     ...
     */
    static <T> LambdaQueryWrapper<T> buildEqQuery(SFunction<T, Serializable> column1, Serializable value1,
