...
public class ShopGoodsService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<SpiderGoods> spiderGoodsList = execute("https://shop367950010.taobao.com", cookie, 1);
        for (SpiderGoods spiderGoods : spiderGoodsList) {
            System.out.println(spiderGoods.getDetailUrl());
        }
    }

    public static List<SpiderGoods> execute(String shopUrl, String cookie, int pageNo) throws Exception {
        List<SpiderGoods> spiderGoodsList = new ArrayList<>();
        ...
        for (Element element : elements) {
            ...
            SpiderGoods spiderGoods = new SpiderGoods();
